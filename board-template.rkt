...
(define board-template `(
  ...
  (rep 6 sp) (vertex #\_ -3 3 -2 2 -2 4) (rep 3 (edge #\_ -2 2 -2 4))
    ...
    (vertex #\_ 2 2 2 4 3 5) (rep 10 sp) #\+ (rep 18 #\-) #\+ nl
  ...
  (rep 2 sp) #\? (vertex sp -3 1 -3 3 -2 2) (edge #\/ -2 3 -2 2) sp sp sp
    ...
    sp sp (num 2 2) sp sp (edge #\\ 2 2 3 3) (vertex sp 2 2 3 1 3 3) #\?
    (rep 6 sp) (str "+---+--------------+") nl
  (rep 4 sp) (edge #\\ -3 1 -2 2) sp sp sp (res -2 2) sp sp sp
    (edge #\/ -2 2 -1 1) sp sp (thief -1 1) sp sp (edge #\\ -1 1 0 2) sp sp sp
    (res 0 2) sp sp (edge #\/ 0 2 1 1) sp sp (thief 1 1) sp sp
    (edge #\\ 1 1 2 2) sp sp sp (res 2 2) sp sp (edge #\/ 2 2 3 1) (rep 8 sp)
    (str "| s | sheep        |") nl
  (rep 5 sp) (edge #\\ -3 1 -2 2) (vertex #\_ -3 1 -2 0 -2 2)
    ...
    (vertex #\_ -1 1 0 0 0 2) (rep 3 (edge #\_ 0 0 0 2)) (vertex #\_ 0 0 0 2 1 1)
    (edge #\/ 0 2 1 1) sp sp sp (num 1 1) sp sp (edge #\\ 1 1 2 2)
    (vertex #\_ 1 1 0 2 2 2) (rep 3 (edge #\_ 0 2 2 2)) (vertex #\_ 0 2 2 2 3 1)
    (edge #\/ 2 2 3 1) (rep 9 sp) (str "| c | clay         |") nl
  (rep 5 sp) (edge #\/ -3 1 -2 0) sp sp (thief -2 0) sp sp (edge #\\ -2 0 -1 1)
    ...
    nl
  (rep 3 sp) (vertex sp -3 -1 -3 1 -2 0) (edge #\/ -3 1 -2 0) sp sp sp
    (num -2 0) sp sp (edge #\\ -2 0 -1 1) (vertex #\_ -2 0 -1 -1 -1 1)
    (rep 3 (edge #\_ -1 -1 -1 1)) (vertex #\_ -1 -1 -1 1) (edge #\/ -1 1 0 0)
    sp sp sp (num 0 0) sp sp (edge #\\ 0 0 1 1) (vertex #\_ 0 0 0 2 1 1)
    (rep 3 (edge #\_ -1 1 1 1)) (vertex #\_ -1 1 1 1 0 2) (edge #\/ 1 1 2 0)
    sp sp sp (num 2 0) sp sp (edge #\\ 2 0 3 1) (vertex sp 2 0 3 -1 3 1)
    (rep 8 sp) (str "| w | wood         |") nl
  ...
  (rep 5 sp) (edge #\/ -3 -1 -2 -2) sp sp (thief -2 -2) sp sp
    ...
    (rep 9 sp) (str "| T | thief        |")
  (rep 3 sp) (vertex sp -3 -3 -3 -1 -2 -2) (edge #\/ -3 -1 -2 -2) sp sp sp
    ...
    (edge #\\ 2 -2 3 -1) (vertex sp 2 -2 3 -3 3 -1) (rep 7 sp)
    (str "| ? | 3:1 post     |") nl
