...
(define board-template `(
  ...
  (rep 13 sp) (hedge -2 4 -1 3 -1 5 0 4) (edge #\/ -1 5 0 4) sp sp sp
    (num 0 4) sp sp (edge #\\ 0 4 1 5) (hedge 0 4 1 3 1 5 2 4) nl
  ...
  (rep 6 sp) (hedge -3 3 -2 2 -2 4 -1 3) (edge #\/ -2 4 -1 3) sp sp sp (num -1 3) sp sp
    (edge #\\ -1 3 0 4) (hedge -1 3 0 2 0 4 1 3) (edge #\/ 0 4 1 3) sp sp sp (num 1 3) sp sp
    (edge #\\ 1 3 2 4) (hedge 1 3 2 2 2 4 3 3) (rep 10 sp) #\+ (rep 18 #\-) #\+ nl
  ...
  (rep 2 sp) #\? (vertex #\space -3 1 -3 3 -2 2) (edge #\/ -3 3 -2 2) sp sp sp
    (num -2 2) sp sp (edge #\\ -2 2 -1 3) (hedge -2 2 -1 1 -1 3 0 2) (edge #\/ -1 3 0 2)
    sp sp sp (num 0 2) sp sp (edge #\\ 0 2 1 3) (hedge 0 2 1 1 1 3 2 2) (edge #\/ 1 3 2 2) sp
  ...
  (rep 5 sp) (edge #\\ -3 1 -2 2) (hedge -3 1 -2 0 -2 2 -1 1)
    ...
    (hedge -1 1 0 0 0 2 1 1)
    (edge #\/ 0 2 1 1) sp sp sp (num 1 1) sp sp
...
(rep 5 sp) (edge #\/ -3 1 -2 0) sp sp (thief -2 0) sp sp (edge #\\ -2 0 -1 1)
  ...
  (rep 3 sp) #\o sp (edge #\\ -3 -1 -2 0) (hedge -3 -1 -2 -2 -2 0 -1 -1)
    ...
    (edge #\\ 1 -1 2 0) (hedge 1 -1 2 -2 2 0 3 -1) (edge #\/ 2 0 3 -1) sp #\c (rep 7 sp)
    (str "| d | desert       |") nl
  ...
  (rep 5 sp) (edge #\\ -3 -3 -2 -2) (hedge -3 -3 -2 -4 -2 -2 -1 -3)
    ...
    (edge #\\ 1 -3 2 -2) (hedge 1 -3 2 -4 2 -2 3 -3)
  ...
  (rep 18 sp) (edge #\\ -1 -5 0 -4) sp sp sp (res 0 -4) sp sp sp
    (edge #\/ 0 -4 1 -5) nl
  (rep 19 sp) (edge #\\ -1 -5 0 -4) (hedge -1 -5 0 -6 0 -4 1 -5) (edge #\/ 0 -4 1 -5)
    nl
  (rep 20 sp) (rep 5 #\?) nl))
